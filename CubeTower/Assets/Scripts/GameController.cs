...
public class GameController : MonoBehaviour
{
    ...
    public GameObject allCubes, vfx, gameScore;
    ...
    private void Start()
    {
        ...
        else posibleCubesToCreate.Add(cubesToCreate[0]);
    ...
    private void Update()
    {
        if ((Input.GetMouseButtonDown(0) || Input.touchCount > 0) && cubeToPlace != null && allCubes != null && !EventSystem.current.IsPointerOverGameObject())
        {
            ...
            else createCube = cubesToCreate[UnityEngine.Random.Range(0, posibleCubesToCreate.Count)];
    ...
    private void MoveCameraChangeBg()
    {
        ...
        scoreTxt.text = "<size=40><color=#E9332D>BEST</color></size>" + PlayerPrefs.GetInt("score") + "\n<size= 35 > Now </size>" + maxY;
